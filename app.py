...
with قاعات_المتحف[1]:
    ...
    # نموذج 3D تفاعلي عالي الدقة للقناع
    st.components.v1.html(
        """
...
with قاعات_المتحف[2]:
    ...
    # نموذج 3D تفاعلي لأبو الهول الحجري
    st.components.v1.html(
        """
